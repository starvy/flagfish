...
| **Member removal vs. team deletion** | Removing a member removes that member's scoring rows; deleting a team detaches its members first. | Asymmetric on purpose. Unchanged, and now explicit. |
