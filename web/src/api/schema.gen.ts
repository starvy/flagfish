...
export interface paths {
    ...
    "/scoreboard/{id}": {
        ...
        /** One account's cumulative score over time (freeze-safe; honours ?as_of) */
        get: operations["scoreboard-detail"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "scoreboard-detail": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ScoreHistoryOutputBody"];
                };
            };
            /** @description Error */
            default: {
